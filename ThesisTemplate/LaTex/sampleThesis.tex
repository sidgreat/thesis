...
\newpage
\thispagestyle{empty}
\renewcommand{\thesisdedication}{{\large Copyright \copyright~~Siddharth Kherada, June 2013\\}{\large All Rights Reserved\\}}
\thesisdedicationpage
...
\newpage
\thispagestyle{empty}
\renewcommand{\thesisdedication}{\large To My Parents and My Guide}
\thesisdedicationpage
...
\chapter{Component Based Modeling}
\label{ch:chap3}
\input{chapter3.tex}

%--------------------------------------------------------

\chapter{3D Text Extraction}
\label{ch:chap4}
\input{chapter4.tex}
